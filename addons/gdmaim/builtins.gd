...
static func __tjKe(__60Ds:String)->String:
	var __TJGd:String
	var __5gZT:PackedStringArray=__60Ds.split("\n")
	for __anRH in __5gZT:
		var __0VEQ:int=__anRH.find("(")
		if __0VEQ!=-1:
			__TJGd+='\n"'+__anRH.substr(0,__0VEQ).replace(" ","")+'",'
	return __TJGd
const __hn4C:Array[Dictionary]=[
	{
		"class":"AABB",
		"properties":[
			"end",
